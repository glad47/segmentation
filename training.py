...
class SegmentationTrainingApp:
    def __init__(self, sys_argv=None):
        ...
        parser.add_argument('--finetune',
            ...
            default='/content/drive/MyDrive/SegmentationProject/content/drive/MyDrive/project/seg_2024-02-09_10.04.25_reduceFP.300000.state',
        )
    ...
    def saveTensorBoardLog(self):
        os.system("cp -r /tmp/log /content/drive/MyDrive/TensorBoardLog")
